...
const MangaSection = ({ onMangaClick }) => {
  ...
  const [activeTab, setActiveTab] = useState("top"); // 'top' | 'search'
  ...
  const loadTopManga = async () => {
    ...
    try {
      ...
      console.error("Error loading top manga:", err);
      ...
      <div className="mb-6 animate-slide-up">
        ...
        {!error && !loading && (
          <div className="flex items-center gap-2 text-sm">
            <span className="inline-block w-2 h-2 bg-[theme(--color-accent)] rounded-full animate-pulse" />
