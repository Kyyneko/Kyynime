        ...
        <div className="container-custom py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-[theme(--color-text-muted)] text-sm text-center">
              Made with  by <a href="https://github.com/Kyyneko" target="_blank" rel="noopener noreferrer" className="text-[theme(--color-primary)] hover:underline font-bold">Kyyneko</a> • Powered by <a href="https://jikan.moe/" target="_blank" rel="noopener noreferrer" className="text-[theme(--color-accent)] hover:underline font-bold">Jikan API</a>
            </p>
